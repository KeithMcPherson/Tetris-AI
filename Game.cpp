...
/* 
======================================									
Returns the game drop speed
====================================== 
*/
int Game::GetDropSpeed ()
{
...
/* 
======================================									
Returns if the user is soft dropping
====================================== 
*/
bool Game::IsSoftDrop ()
{
	return this->mSoftDrop;
}
...
====================================== 
*/
void Game::SetSoftDrop (bool enabled)
{
	this->mSoftDrop = enabled;
}
...
void Game::DrawBoard ()
{
	...
	char scoreBuffer [10];
	scoreSS << "score: " << itoa(this->GetScore(), scoreBuffer, 10);
	string scoreText = scoreSS.str();
	
	const char* scorec_str = scoreText.c_str();
	char* finalScore = const_cast<char*>(scorec_str);

	// Draw score
	mIO->DrawSomeText (finalScore, 0, 0);
	

	stringstream weightSS;
	char weightBuffer [10];
	weightSS << "Board AI weight: " << itoa(mBoard->GetBoardWeight(), weightBuffer, 10);
	string weightText = weightSS.str();
	
	const char* weightc_str = weightText.c_str();
	char* finalWeight = const_cast<char*>(weightc_str);

	// Draw Weight
	mIO->DrawSomeText (finalWeight, 0, 20);
